...
For more information and an R package encapsulating the bulk of these areal apportionment operations and code, please visit: https://github.com/SarahValencia/ArealApportionment.Note that these methods have been generalized for widespread use as an R library.
